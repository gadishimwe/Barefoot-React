												...
												<Grid container spacing={2} className={classes.tripContainer} key={index}>
													...
													<Grid item xs>
														<Autocomplete
															...
															// getOptionLabel={option => option.accommodation}
															style={{ minWidth: 220 }}
															name={`trips[${index}].accommodation`}
															// onChange={(event, value) =>
															// 	props.setFieldValue(`trips[${index}].accommodation`, value)
															// }
															renderInput={params => (
																<TextField
																	{...params}
																	...
																	variant='outlined'
																	fullWidth
																	value={props.values.trips[index].accommodation}
																/>
															)}
														/>
													</Grid>
